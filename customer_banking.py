...
def main():
    ...
    savings_maturity=int(input("Enter your months :  "))
    ...
    print(f"updated_savings_balance : {updated_savings_balance}")
    # Prompt the user to set the CD balance, interest rate, and months for the CD account.
    # ADD YOUR CODE HERE

    cd_balance = float(input('Enter your starting balance : '))
    cd_interest = float(input('Enter your interest rate : '))
    cd_maturity=int(input("Enter your months :  "))
    ...
    print(f"CD updated_cd_balance ;   {updated_cd_balance}")
